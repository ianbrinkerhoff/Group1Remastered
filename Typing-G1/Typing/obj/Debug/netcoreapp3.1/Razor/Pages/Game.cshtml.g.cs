#pragma checksum "D:\Ian Brinkerhoff\Coding\Nov5\Group1Remastered\Typing-G1\Typing\Pages\Game.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "8cb3a471a16b40ecb8abe83d2a651674efc18efc"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"8cb3a471a16b40ecb8abe83d2a651674efc18efc", @"/Pages/Game.cshtml")]
...
#nullable restore
#line 7 "D:\Ian Brinkerhoff\Coding\Nov5\Group1Remastered\Typing-G1\Typing\Pages\Game.cshtml"
...
#nullable disable
        ...
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8cb3a471a16b40ecb8abe83d2a651674efc18efc5876", async() => {
    ...
    <div class=""right"" id=""p2"">
        ...
        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8cb3a471a16b40ecb8abe83d2a651674efc18efc8220", async() => {
...
");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "8cb3a471a16b40ecb8abe83d2a651674efc18efc10238", async() => {
            }
            );
...
<script>
    ...
    connection.on(""ReceiveMessage"", function (username, input) {
        ...
        if (msg == ""ready"") {
            ...
            var $div = $('#gameScreen'),
                $half = $('#p2'),
        ");
            WriteLiteral(@"        docWidth = $div.width(),
                halfW = $half.width()
    ...
    ");
            WriteLiteral(@"                } else if (p2count < 30) {
    ...
    $('#tb1').keyup(function () {
        var username = '");
#nullable restore
#line 151 "D:\Ian Brinkerhoff\Coding\Nov5\Group1Remastered\Typing-G1\Typing\Pages\Game.cshtml"
                   Write(UserStatus.currentUser);
...
#nullable disable
    ...
    $('#startBtn').click(function () {
        ...
        if ($('#waiting').text() == 'Player Ready!') {
            ...
            var username = '");
#nullable restore
#line 167 "D:\Ian Brinkerhoff\Coding\Nov5\Group1Remastered\Typing-G1\Typing\Pages\Game.cshtml"
                       Write(UserStatus.currentUser);
...
#nullable disable
    ...
    function sendStartMessage() {
        var username = '");
#nullable restore
#line 176 "D:\Ian Brinkerhoff\Coding\Nov5\Group1Remastered\Typing-G1\Typing\Pages\Game.cshtml"
                   Write(UserStatus.currentUser);
...
<script>
    ...
    function animateTwo() {
        ...
        $.each($('#p2'), function (i, left) {
            ...
            $('div', left).each(function () {
                ...
                x2++;
                $");
            WriteLiteral(@"(this).animate({ left: (fullWidth - 75) + 'px' }, 20000, 'linear', function () {
                    gameOverP2();
                });
    ...
    $('#tb1').keyup(function () {
        ...
        $('.wordBox1').each(function () {
            ...
            if (string == substring) {
                ...
                if (p1count < 10) {
                    $(this).animate({ left: (docWidth - 75) + 'px' }, 200");
            WriteLiteral(@"00, 'linear', function () { gameOverP1(); });
                } else if (p1count < 20) {
    ...
    function gameOverP1() {
        ...
        $('#p1Final').html(""Game");
            WriteLiteral(@" Over!<br>Final score: "" + p1Score);
        $('#p1Final').css({
            'visibility': 'visible',
            'position': 'absolute',
            'left': '40%',
