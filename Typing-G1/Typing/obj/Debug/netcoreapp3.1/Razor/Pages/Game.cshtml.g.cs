#pragma checksum "C:\Users\ianbr\Desktop\CS3750\Group1Remastered\Typing-G1\Typing\Pages\Game.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "f8c55e714ef41a670e5ef5934f7a7c3da0ad5a30"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"f8c55e714ef41a670e5ef5934f7a7c3da0ad5a30", @"/Pages/Game.cshtml")]
...
#nullable disable
            ...
            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f8c55e714ef41a670e5ef5934f7a7c3da0ad5a305521", async() => {
        ...
        <div class=""right"" id=""p2"">
            ...
            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f8c55e714ef41a670e5ef5934f7a7c3da0ad5a307778", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "f8c55e714ef41a670e5ef5934f7a7c3da0ad5a309540", async() => {
            }
            );
...
<script>
    ...
    [
        ...
        ""SWIM"", ""APPLE"", ""CARROT"", ""BOOK"", ""COIN"", ""CUPCAKE"",");
            WriteLiteral(@" ""PENCIL"", ""BOAT"", ""FINGER"", ""DOOR""
    ];
</script>
...
<script>
    ...
    $('#tb1').keyup(function () {
        var username = '");
#nullable restore
#line 120 "C:\Users\ianbr\Desktop\CS3750\Group1Remastered\Typing-G1\Typing\Pages\Game.cshtml"
                   Write(UserStatus.currentUser);
...
#nullable disable
    ...
    $('#start').click(function () {
        ...
        var username = '");
#nullable restore
#line 130 "C:\Users\ianbr\Desktop\CS3750\Group1Remastered\Typing-G1\Typing\Pages\Game.cshtml"
                   Write(UserStatus.currentUser);
        ...
        $.each($('#p1'), function (i, left) {
            ...
            $('div', left).each(function () {
                $(this).css({
                    'position': 'absolute',
                    'top': ((d");
            WriteLiteral(@"ocHeight - 75) * (x / 5)) + 'px'
                });
                x++;
                $(this).animate({ left: (docWidth - 100) + 'px' }, 20000);
    ...
    $('#tb1').keyup(function () {
        ...
        $('.wordBox1').each(function () {
            ...
            if (string == substring) {
                ...
                if (p1count < 10) {
             ");
            WriteLiteral(@"       $(this).animate({ left: (docWidth - 100) + 'px' }, 20000);
                } else if (p1count < 20) {
                    $(this).animate({ left: (docWidth - 100) + 'px' }, 17000);
                } else if (p1count < 30) {
                    $(this).animate({ left: (docWidth - 100) + 'px' }, 15000);
