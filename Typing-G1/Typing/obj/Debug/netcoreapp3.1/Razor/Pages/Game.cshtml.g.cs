#pragma checksum "D:\Ian Brinkerhoff\Coding\Nov5\Group1Remastered\Typing-G1\Typing\Pages\Game.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7fad10ab2e4c5dae93ae5091c4dc655c85ca2db1"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7fad10ab2e4c5dae93ae5091c4dc655c85ca2db1", @"/Pages/Game.cshtml")]
...
#nullable disable
            ...
            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7fad10ab2e4c5dae93ae5091c4dc655c85ca2db15494", async() => {
        ...
        <div class=""right"" id=""p2"">
            ...
            ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7fad10ab2e4c5dae93ae5091c4dc655c85ca2db17743", async() => {
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "7fad10ab2e4c5dae93ae5091c4dc655c85ca2db19505", async() => {
            }
            );
...
<script>
    ...
    [
        ...
        ""SWIM"", ""APPLE"", ""CARROT"", ""BOOK"", ""COIN"", ""CU");
            WriteLiteral(@"PCAKE"", ""PENCIL"", ""BOAT"", ""FINGER"", ""DOOR""
    ];
</script>
...
<script>
            ...
            WriteLiteral(@"tion () {
                ...
                if (string == substring) {
                    ...
                    if (p2count < 10) {
                        ...
                        $(this).animate({ left: (docWidth - 100) + 'px' }");
            WriteLiteral(@", 13000);
                    }
                }
    ...
    $('#tb1').keyup(function () {
        var username = '");
#nullable restore
#line 130 "D:\Ian Brinkerhoff\Coding\Nov5\Group1Remastered\Typing-G1\Typing\Pages\Game.cshtml"
                   Write(UserStatus.currentUser);
...
#nullable disable
    ...
    $('#startBtn').click(function () {
        ...
        if ($('#waiting').text() == 'Player Ready!') {
            ...
            var username = '");
#nullable restore
#line 146 "D:\Ian Brinkerhoff\Coding\Nov5\Group1Remastered\Typing-G1\Typing\Pages\Game.cshtml"
                       Write(UserStatus.currentUser);
...
#nullable disable
    ...
    function sendStartMessage() {
        var username = '");
#nullable restore
#line 155 "D:\Ian Brinkerhoff\Coding\Nov5\Group1Remastered\Typing-G1\Typing\Pages\Game.cshtml"
                   Write(UserStatus.currentUser);
...
//PLAYER 1 SIDE USING ANIMATE
        function animateOne() {
            ...
            $('#user2').css({
                'left': ((docWidth /");
            WriteLiteral(@" 2) + docWidth) - 100 + 'px',
                'visibility': 'visible'
            });
            ...
            $.each($('#p2'), function (i, left) {
                ...
                $('div', left).each(function () {
                    $(this).css({
                        'position': 'absolute',
                        'top':");
            WriteLiteral(@" ((docHeight) * (x2 / 5) + 50) + 'px'
                    });
                    x2++;
    ...
    $('#tb1').keyup(function () {
        ...
        $('.wordBox1').each(function () {
            ...
            if (string == substring) {
                ...
                if (p1count < 10) {
                    $(this).ani");
            WriteLiteral(@"mate({ left: (docWidth - 100) + 'px' }, 20000);
                } else if (p1count < 20) {
                    $(this).animate({ left: (docWidth - 100) + 'px' }, 17000);
                } else if (p1count < 30) {
                    $(this).animate({ left: (docWidth - 100) + 'px' }, 15000);
